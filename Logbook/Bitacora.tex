...
Se realizo la unión de los los módulos de la RTC, el control de usuario y la VGA, se realizó la simulación post síntesis \ref{fig:postsynt}, y se verificó que los tiempos estuvieran corectos. \\
...
\noindent \textbf{Integrantes:} Luis Leon  \\[1ex]
\textbf{Hora:} Durante varios periodos del día \\[1ex]
\textbf{Actividad:} \\[2ex]
Se reimplementó el sistema de punteros del módulo de la VGA con la finalidad de reducir el periodo de propopagación de las señales, especialmente, las entradas con referencia al reloj hacia la salida.
\\
...
\textbf{Actividad:} \\[2ex]
Se rediseñó el control de usuario, debido a las fallas del anterior, ahora se conforma de una maquina de estados de punteros de memoria, dos registros para incrementar y disminuir los valores del clk , y una maquinas de estados de escritura.
\\
...
\textbf{Actividad:} \\[2ex]
La escritura y la lectura funcionan, no obstante la programacion del timer no se ha podido realizar. Ademas la pantalla muestra pequeños glitches.
\\
...
\textbf{Actividad:} \\[2ex]
El proyecto funciona correctamente, se lograron corregir la mayoría de los glitches de pantalla, y el timer corre de manera descendente, además se logró encender y apagar el ring.
Se realizó la medición de los señales de comunicación con la RTC por medio de un analizador lógico.
\\
\begin{figure}[htbp]
	\centering
